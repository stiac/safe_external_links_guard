...
| Modulo | Stato | Note |
| --- | --- | --- |
| Gestione modale (links-guard.js) | Aggiornato | Abilitato il listener delegato per compatibilità con modalità lettura, introdotte le utility AMP (`collectExternalLinks`, `applyPolicies`) e mantenuta la protezione dei link in contesti a esecuzione limitata.
...
| Documentazione | Aggiornata | README, CHANGELOG, VERSION, ROADMAP e report allineati alla release 1.9.0 con istruzioni per Reader mode, fallback AMP e validazione server-side.
